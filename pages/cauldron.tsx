...
import CauldronManager from '../components/cauldronManager';
    ...
    <div className={styles.container}>
      ...
      <div className="mx-auto my-10 bg-amber-300">
        <div className="flex justify-center">
          <h1 className="logo font-workSans ml-5 py-10 svg-background">CAULDRON TOP UP</h1>
        </div>
      </div>

      <div className="container mx-auto">
        <CauldronManager setFlashMessage={setFlashMessage}></CauldronManager>
      </div>
    </div>
  );
};
